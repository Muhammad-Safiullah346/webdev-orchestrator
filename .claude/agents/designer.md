---
name: designer
description: "Design-system author. Runs the design suite to pick style/palette/fonts, then publishes tokens + semantic registry. Runs before frontend on a feature branch."
